...
import com.iprism.swenhealth.databinding.FragmentOnlineDoctorOngoingBookingsBinding
...
class OnlineDoctorOngoingBookingsFragment : Fragment() {
    ...
    private lateinit var binding: FragmentOnlineDoctorOngoingBookingsBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
       binding = FragmentOnlineDoctorOngoingBookingsBinding.inflate(inflater, container, false)
        setupAdapter()
        return binding.root
    }
