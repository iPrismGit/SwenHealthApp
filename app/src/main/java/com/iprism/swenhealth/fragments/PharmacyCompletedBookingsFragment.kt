...
class PharmacyCompletedBookingsFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPharmacyCompletedBookingsBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentPharmacyCompletedBookingsBinding.inflate(inflater, container, false)
        setupAdapter()
        return binding.root
    }
