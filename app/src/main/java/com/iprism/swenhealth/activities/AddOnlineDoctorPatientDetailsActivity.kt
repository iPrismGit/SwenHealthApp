...
import com.iprism.swenhealth.databinding.ActivityAddOnlineDoctorPatientDetailsBinding
import com.iprism.swenhealth.interfaces.OnMultipleFamilyItemClickListener

class AddOnlineDoctorPatientDetailsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAddOnlineDoctorPatientDetailsBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityAddOnlineDoctorPatientDetailsBinding.inflate(layoutInflater)
